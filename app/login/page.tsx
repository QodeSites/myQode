    ...
    <main id="main-content" tabIndex={-1} className="min-h-screen flex flex-col items-center bg-background justify-center gap-8">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex gap-3">
          <a
            href="https://apps.apple.com/in/app/myqode/id6761060137"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-foreground text-background rounded-lg px-3 py-1.5 hover:opacity-80 transition-opacity"
          >
          ...
          <a
            href="https://play.google.com/store/apps/details?id=com.qodeinvest.myqode"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-foreground text-background rounded-lg px-3 py-1.5 hover:opacity-80 transition-opacity"
          >
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.18 23.76c.3.17.64.24.99.2l13.12-7.57-2.83-2.83-11.28 10.2zM.55 1.22C.2 1.57 0 2.1 0 2.79v18.42c0 .69.2 1.22.55 1.57l.08.08 10.32-10.32v-.24L.63 1.14l-.08.08zM20.1 10.37l-2.77-1.6-3.16 3.16 3.16 3.16 2.79-1.61c.8-.46.8-1.21-.02-1.67v-.44zM4.17.24l13.12 7.57-2.83 2.83L3.18.44C3.48.07 3.87-.1 4.17.24z"/>
            </svg>
            <div className="flex flex-col leading-none">
