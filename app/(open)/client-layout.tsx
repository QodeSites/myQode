...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            ...
            <div className="my-20 p-4 sm:p-6 md:p-2 flex-1">
                <div className="flex min-h-[calc(100vh-8rem)] gap-4 items-start px-4 sm:px-6 md:px-6">
                    ...
                    <main className="flex-1 overflow-y-auto">
                        <div className="w-full h-fit rounded-lg bg-card p-4 sm:p-6 card-shadow">
