...
async function sendSetupEmail(email: string, clientName: string, setupLink: string, clientCode: string) {
  ...
  const mailOptions = {
    from: `"Qode Advisors" <${process.env.EMAIL_FROM}>`,
    to: email,
    subject: 'Welcome to Qode - Set Up Your Investment Dashboard Access',
    html: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
                ...
                <div class="access-section">
                    ...
                    <div class="access-content">
                        ...
                        <div class="password-reset">
                            Password reset: We suggest you change your password after your first login. To change your password - log out and select "Forgot Password" to reset it.
                        </div>
                    </div>
                </div>
