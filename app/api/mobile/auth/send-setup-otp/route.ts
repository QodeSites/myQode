// POST /api/mobile/auth/send-setup-otp
// Sends a 6-digit password-setup OTP to a new user's registered email.
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Find client by email — only those still on the default password / pending onboarding
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p><strong>Verification via:</strong> myQode Mobile App</p>
            ...
            <p>You requested to set up your password for your Qode investment dashboard. Please enter this verification code in the myQode app to proceed with your password setup.</p>
            ...
            <p class="footer-text">
              This message was sent from the myQode app. If you have any questions about your account setup, please contact our support team.
            </p>
          </div>
        </div>
      </body>
    ...
    try {
      ...
      console.error('Failed to send setup OTP email:', mailErr);
    ...
    console.error('Mobile send setup OTP error:', error);
    return NextResponse.json({ error: 'Failed to send OTP' }, { status: 500 });
  }
}
