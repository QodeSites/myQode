...
export async function POST(request: NextRequest) {
  try {
      ...
      try {
        ...
        await query(
          `UPDATE pms_clients_master 
           ...
           WHERE clientcode = $3`,
          [token, expires, client.clientcode]
        );

        // Send email
        const setupLink = `http://localhost:3000/auth/setup-password?token=${token}`;
        await sendSetupEmail(client.email, client.clientname, setupLink, client.clientcode);

        sentCount++;
      } catch (error) {
        console.error(`Failed to send email to ${client.clientcode}:`, error);
    ...
    return NextResponse.json({
      success: true,
      sentCount,
      totalRequested: clientCodes.length,
...
async function sendSetupEmail(email: string, clientName: string, setupLink: string, clientCode: string) {
  ...
  try {
    await resend.emails.send({
      ...
      to: [email],
      subject: 'myQode is live: track, invest, and access reports in one place',
      html: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
            ...
            <div class="content">
                ...
                <div class="features-section">
                    ...
                    <div class="features-content">
                        <div style="padding: 15px 25px; font-size: 14px; color: #333; font-weight: 400; margin: 0; background-color: #efecd3;">
                        ...
                        <div style="padding: 15px 25px; font-size: 14px; color: #333; font-weight: 400; margin: 0; background-color: #fff;">
                ...
                <!-- Contact Section -->
                <div style="border-top: 2px solid #dabd38; margin: 20px 0; padding-top: 20px;">
                ...
                <div style="border-bottom: 2px solid #dabd38; margin: 20px 0; padding-bottom: 20px;"></div>
                </div>
                ...
                <div style="margin:10px 0px; text-align: center;">
                    <a href="mailto:support@qodeinvest.com?subject=Request%20for%20myQode%20Walkthrough" style="background-color: #02422b; color: white; padding: 18px 20px; border: none; border-radius: 4px; font-size: 14px; font-weight: 600; font-family: 'Lato', Arial, sans-serif; cursor: pointer; display: inline-block; text-decoration: none;">Request a live walkthrough</a>
                </div>
                ...
                <!-- Footer -->
                <div class="footer" >
                    <div class="footer-logo" style="font-weight:700;">Qode</div>
