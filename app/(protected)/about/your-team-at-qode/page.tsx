      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div>
          <Section title="Fund Manager" icon={<TrendingUp className="h-5 w-5 text-primary" />}>
            ...
            <p>
              <strong>When to Contact:</strong> Strategy-specific queries and high-level portfolio discussions.
            </p>
            <Button
        ...
        <div>
          <Section title="Investor Relations" icon={<User className="h-5 w-5 text-primary" />}>
            ...
            <p className="mb-0">
              <strong>When to Contact:</strong> For reports, account queries, operational clarifications, and all quarterly/annual reviews.
            </p>
        ...
        <div>
          <Section title="WhatsApp/Email" icon={<MessageCircle className="h-5 w-5 text-primary" />}>
            ...
            <div className="mt-2">
              <a
                href="https://chat.whatsapp.com/IW7eHWZjWAq54MyKvZtQdC"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-md border border-[#DABD38] bg-[#DABD38] text-[#002017] px-4 py-2 text-sm font-semibold hover:opacity-90"
              >
                ...
                Join Qode Investor Circle
              </a>
              <p className="mt-1 text-xs text-muted-foreground">WhatsApp community for Qode investors</p>
            </div>
          </Section>
        </div>
      </div>
