      ...
      <section className="mx-auto w-full py-8 space-y-8">
        ...
        <div className="space-y-4 text-center">
          ...
          <div className="flex flex-col items-center gap-2 pt-2">
            <p className="text-sm text-muted-foreground">Need help setting up your password on the WealthSpectrum portal?</p>
            <a
              href="/tutorial-document/How to Generate Your Password on Wealth Spectrum.pdf"
              target="_blank"
              rel="noreferrer"
              aria-label="View guide: How to Generate Your Password on Wealth Spectrum"
              className="inline-flex items-center gap-2 rounded-md border border-border bg-secondary px-4 py-2 text-sm font-medium text-foreground hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
