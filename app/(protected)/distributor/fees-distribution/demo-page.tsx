...
const dummyRows: CalculatorRow[] = [
  ...
  {
    id: 4,
    clientName: "XYZ Delta Partners",
    strategy: "Conservative Strategy",
    inceptionDate: "5-May-23",
    averageAum: "60,00,000.00",
    performanceFees: "90,000.00",
    performanceFeesGst: "16,200.00",
    fixedFees: "30,000.00",
    fixedFeesGst: "5,400.00",
    totalFees: "1,20,000.00",
    totalFeesGst: "21,600.00",
    totalFeesCollected: "1,41,600.00",
    distributorPercentage: "30%",
    distributorShare: "42,480.00",
    accountcode: "ACC004",
    billgroup: "QODEPMS MF1.5 PF15 H8 Q NEW",
  },
  {
    id: 5,
    clientName: "XYZ Epsilon Investments",
    strategy: "Balanced Strategy",
    inceptionDate: "18-Nov-24",
    averageAum: "85,00,000.00",
    performanceFees: "1,27,500.00",
    performanceFeesGst: "22,950.00",
    fixedFees: "42,500.00",
    fixedFeesGst: "7,650.00",
    totalFees: "1,70,000.00",
    totalFeesGst: "30,600.00",
    totalFeesCollected: "2,00,600.00",
    distributorPercentage: "30%",
    distributorShare: "60,180.00",
    accountcode: "ACC005",
    billgroup: "QODEPMS MF2.5 PF25 H10 Q NEW",
  },
];
